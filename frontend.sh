...
echo -e "\e[31m Installing nginx server \e[0m"  | tee -a /tmp/roboshop.log
...
echo -e "\e[31m Downloading roboshop content \e[0m"  | tee -a /tmp/roboshop.log
curl -o /tmp/frontend.zip https://roboshop-artifacts.s3.amazonaws.com/frontend.zip &>>${log}
cd /usr/share/nginx/html &>>${log}
echo -e "\e[31m extracting roboshop content \e[0m" | tee -a /tmp/roboshop.log
